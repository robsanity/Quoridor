...
void LCD_DrawBoard(uint16_t color);
void LCD_Colora(uint16_t x0, uint16_t y0, uint16_t x1, uint16_t y1 , uint16_t color );
void LCD_Pedina1(uint16_t x, uint16_t y);
void LCD_Pedina2(uint16_t x, uint16_t y);	
void LCD_DisplayWalls2(char wall2);
void LCD_DisplayWalls1(char wall1);
void LCD_DisplayTimer(char time_left);
void LCD_ColorMovesP1(void);
void LCD_ColorMovesP2(void);
void LCD_ConfirmMove(void);
void LCD_DisplayWall(uint16_t x, uint16_t y, char orientation, uint16_t color);
void LCD_DisplayMove(char choice,struct Pedina);
void LCD_RemoveWall(uint16_t x, uint16_t y, char orientation);
